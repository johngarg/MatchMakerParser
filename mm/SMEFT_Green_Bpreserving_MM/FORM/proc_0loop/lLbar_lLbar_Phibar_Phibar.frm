...
#include lLbar_lLbar_Phibar_Phibar.aux;
...
G  ampllLbarlLbarPhibarPhibar=expr1+...+expr`NumDiags';

#else
G ampllLbarlLbarPhibarPhibar=0;
...
#write <lLbar_lLbar_Phibar_Phibar.out> "%X"
print +f;
