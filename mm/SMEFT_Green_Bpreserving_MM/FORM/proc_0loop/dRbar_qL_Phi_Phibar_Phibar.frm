...
#include dRbar_qL_Phi_Phibar_Phibar.aux;
...
G  ampldRbarqLPhiPhibarPhibar=expr1+...+expr`NumDiags';

#else
G ampldRbarqLPhiPhibarPhibar=0;
...
#write <dRbar_qL_Phi_Phibar_Phibar.out> "%X"
print +f;
