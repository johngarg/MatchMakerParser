...
S g1, g2, g3, lam, muH, lambdaEDelta1, MDelta1, lambdaHatEDelta1, ME, lambdaEDelta1bar, lambdaHatEDelta1bar;
#define flFunc "lambdaDelta1, lambdaE, yd, yl, yu, lambdaDelta1bar, lambdaEbar, ydbar, ylbar, yubar, ddF";
#define flmassFunc "";
#define gFunc "C2224, C344, Eps4, EpsSU3, K6, T2244, T6, C2224bar, C344bar, Eps4bar, EpsSU3bar, K6bar, T6bar, Ta, Ta4, FSU2L, T6, T, FSU3C, fsu2, fsu3, ee, ee2, dd";
